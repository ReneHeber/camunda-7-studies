...
public class ChargeCardWorkerMicroEx9 {
    private final static Logger LOGGER = Logger.getLogger(ChargeCardWorkerMicroEx9.class.getName());
        ...
        client.subscribe("charge-credit-card")
                ...
                .handler((externalTask, externalTaskService) -> {
                    ...
                    if (credit <= -1000) {
                        ...
                        variables.put("fixable", true);

                        // report bmpn error
                        externalTaskService.handleBpmnError(externalTask, "charge_error", "Charge error occurred", variables);
                    } else {
                        // Complete the task
